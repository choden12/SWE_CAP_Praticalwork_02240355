...
print("Maximum value:", bst.find_maximum())  # Should print the maximum value in the BST
print("Total number of nodes:", bst.count_nodes())  # Should print the count of nodes in the BST
print("Level-order traversal:", bst.level_order_traversal())  # Should print values in level-order
print("Height of the BST:", bst.find_height())  # Should print the height of the BST
print("Is valid BST:", bst.is_valid_bst())  # Should return True if the BST is valid
